...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_email_templates_type" AS ENUM('applicant_confirmation', 'admin_notification');
  CREATE TYPE "public"."enum_trainings_discipline" AS ENUM('Schwimmen', 'Laufen');
  ...
  CREATE TABLE "locations" (
  	...
  	"address" varchar,
  	"image_id" integer,
  	"confirmation_template_id" integer NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "trainings" (
  	...
  	"discipline" "enum_trainings_discipline" NOT NULL,
  ...
  ALTER TABLE "locations" ADD CONSTRAINT "locations_confirmation_template_id_email_templates_id_fk" FOREIGN KEY ("confirmation_template_id") REFERENCES "public"."email_templates"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "trainings" ADD CONSTRAINT "trainings_location_id_locations_id_fk" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "locations_confirmation_template_idx" ON "locations" USING btree ("confirmation_template_id");
  CREATE INDEX "locations_updated_at_idx" ON "locations" USING btree ("updated_at");
  CREATE INDEX "locations_created_at_idx" ON "locations" USING btree ("created_at");
  CREATE UNIQUE INDEX "email_templates_name_idx" ON "email_templates" USING btree ("name");
  ...
  CREATE INDEX "trainings_location_idx" ON "trainings" USING btree ("location_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_trainings_discipline";`)
}
